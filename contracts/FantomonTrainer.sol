...
//import "contracts/IFantomonTrainer.sol";
import "contracts/Base64.sol";
import "contracts/IFantomon.sol";
import "contracts/IFantomonLocation.sol";
import "contracts/FantomonTrainerGraphics.sol";
import "./FantomonTrainerGraphics.sol";
import "hardhat/console.sol";

interface IFantomonTrainer is IERC721Enumerable{
...
/* TODO
    Test plain all _leave* functions from location contracts

    Add stats to metadata
    ensure that approved arena/location cannot call onlyCurrentLocation functions if not current location

    Ensure that you cannot be in 2 battles at once nor can you be in a battle and rift at same time

    Go through all Trainer functions and make sure we are testing

    Limit scope of functions to smallest possible (view, internal, external, pure)
    nonReentrant to any necessary functions
    SafeMath?
    Code coverage????
    Gas estimation
        - better to omit events from this contract?

    cleanup and comments
    Search for TODO and FIXME in repo
    Remove hardhat console sol from ALL contracts
*/
